...
public class FtpUtil {
    ...
    public static Boolean uploadFile(String host, int port, String username, String password, String basePath,
        ...
        try {
            ...
            // 7.changeWorkingDirectory()：检测目录地址(/home/ftp/www/2020/05/01)是否存在
            // basePath:/home/ftp/www
            // filePath:当前的日期(2020/05/01)
            // /home/ftp/www/2020/05/01
            // 返回Boolean类型，如果返回true则说明目录存在，不需要创建目录，如果返回false则说明目录不存在需要创建
            if (!ftp.changeWorkingDirectory(basePath + filePath)) {
                // 8.filePath进行分割 dirs = ["2020", "05", "01"]
                ...
                for (String dir : dirs) {
                    ...
                    tempPath += "/" + dir;
                    // 10再次检测目标目录是否存在(/home/ftp/www/2020)
